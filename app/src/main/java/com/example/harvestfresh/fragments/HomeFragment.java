...
////                Toast.makeText(getContext(), OFFLINE_MESSAGE, Toast.LENGTH_SHORT).show();
//            }
//        });
//        queryStores();
...
//                        for(StoreFrontRoom store: savedStores) {
//                            StoreFrontRoom  storeFrontRoom = new StoreFrontRoom(store., store.id);
//                            storeFrontDao.insertStoreFront(store);
//                            List<StoreFrontRoom> savedStores = storeFrontDao.recentStores();
//                        }
//                        Log.d(TAG,"Size " + savedStores.size() );
